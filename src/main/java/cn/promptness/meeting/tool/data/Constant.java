...
public class Constant {
    ...
    static {
        ...
        ROOM_INFO_LIST.put("31", "20F 芝加哥·拉歇尔大街");
    ...
    static {
        ...
        CRON_LIST.put("每周一10分/次", "0 0/10 * ? * 1");
        CRON_LIST.put("每周二10分/次", "0 0/10 * ? * 2");
        CRON_LIST.put("每周三10分/次", "0 0/10 * ? * 3");
        CRON_LIST.put("每周四10分/次", "0 0/10 * ? * 4");
        CRON_LIST.put("每周五10分/次", "0 0/10 * ? * 5");

        CRON_LIST.put("工作日3分/次", "0 0/3 * ? * 1-5");
        CRON_LIST.put("每周一3分/次", "0 0/3 * ? * 1");
        CRON_LIST.put("每周二3分/次", "0 0/3 * ? * 2");
        CRON_LIST.put("每周三3分/次", "0 0/3 * ? * 3");
        CRON_LIST.put("每周四3分/次", "0 0/3 * ? * 4");
        CRON_LIST.put("每周五3分/次", "0 0/3 * ? * 5");

        CRON_LIST.put("工作日1分/次", "0 0/1 * ? * 1-5");
        CRON_LIST.put("每周一1分/次", "0 0/1 * ? * 1");
        CRON_LIST.put("每周二1分/次", "0 0/1 * ? * 2");
        CRON_LIST.put("每周三1分/次", "0 0/1 * ? * 3");
        CRON_LIST.put("每周四1分/次", "0 0/1 * ? * 4");
        CRON_LIST.put("每周五1分/次", "0 0/1 * ? * 5");
